...
link_ struct Type	*name##_at(struct VectorType *, size_t);\
link_ struct Type const	*name##_atc(struct VectorType const *, size_t);\
link_ struct Type	*name##_back(struct VectorType *);\
link_ void		name##_init(struct VectorType *, size_t);\
link_ void		name##_erase(struct VectorType *, size_t);\
link_ void		name##_clean(struct VectorType *);\
link_ struct Type	*name##_front(struct VectorType *);\
link_ struct Type	*name##_insert(struct VectorType *, size_t);\
link_ void		name##_pop_back(struct VectorType *);\
link_ void		name##_pop_front(struct VectorType *);\
link_ struct Type	*name##_push_back(struct VectorType *);\
link_ struct Type	*name##_push_front(struct VectorType *);\
link_ void		name##_reserve(struct VectorType *, size_t);\
link_ void		name##_resize(struct VectorType *, size_t)
