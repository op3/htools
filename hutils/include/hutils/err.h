...
void	hutils_verr(int, char const *, va_list) FUNC_PRINTF(2, 0);
void	hutils_verrc(int, int, char const *, va_list) FUNC_PRINTF(3, 0);
void	hutils_verrx(int, char const *, va_list) FUNC_PRINTF(2, 0);
void	hutils_vwarn(char const *, va_list) FUNC_PRINTF(1, 0);
void	hutils_vwarnc(int, char const *, va_list) FUNC_PRINTF(2, 0);
void	hutils_vwarnx(char const *, va_list) FUNC_PRINTF(1, 0);
